...
function getQuestionInfo() {
    ...
    var url = '/project/queryQuestContextEnd';
    jQuery.ajax({
...
function layOutSend() {
    ...
    if (sendType == '0') {
        ...
        if (persons.length == 0) {
            ...
            jQuery.ajax({
                type: "POST",
                url: httpRequestUrl + "/project/selSum",    //查短信条数
                dataType: 'json',
                contentType: "application/json",
                success: function (result) {
                    ...
                    if (persons > result) {
                        ...
                        var url = '/project/addSendQuestionnaire';
        ...
        if (persons.length == 0) {
            ...
            var data = {
                ...
                "dataId": dataId,                    //问卷类型
                "releaseTime": "",            //发送时间
                "sendType": sendType,                //发送类别，0短信，1邮件，2链接
                "questionEndContent": endContent,        //答卷结束语
                "sendInfo": personsData                     //人员信息
            };
            // layer.closeAll('loading');
