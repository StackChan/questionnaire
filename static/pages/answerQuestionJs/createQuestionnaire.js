...
$(function () {
    ...
    var url = '/project/queryAllDataType';
    var da = {'parentId': '1'};
...
function importQuestion(type) {
    ...
    if (type == 1) {
        var url = '/project/queryHistoryQuestionnaire';
        var da = {
        ...
        var urlModal = '/project/queryQuestionnaireMould';
        var da1 = {
            'dataId': dataId
        };
...
function deleteModal(that, modalId) {
    ...
    layer.confirm('您确认要删除此模板吗？', {
        ...
        var url = '/project/deleteQuestionnaireById';
        var da = {
            'id': modalId
        };
...
function createModal() {
    ...
    var url = '/project/addQuestionnaire';
...
function importModal(questionId, questionName, questionContent,projectId) {
    ...
    setCookie('dataId', dataId);
    window.location.href = 'namedQuestionnaire.html?i=1';
}
