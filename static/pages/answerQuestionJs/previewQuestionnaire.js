...
function submitQuestionnaire() {
    if (eORp == "zzz") {
        ...
        var url = '/project/addAnswerQuestionnaire';
...
//生成二维码
function getQrcode() {
    var url = '/project/getShortUrlForLink';
    var da = {
        'id': id
    };
    //console.log(da);
...
function onclickChoose(questionnaireId,problemId) {
    var url = '/project/selectCorrelation';//获得问卷题目的互斥
    var data={
...
function onclickCheckChoose(questionnaireId, problemId) {
    ...
    if (checkedList.length == 0) {
        var url = '/project/selectCheckedCorrelation';//获得问卷题目的互斥
        var data = {
            problemNum: questionnaireId,
        ...
        var url = 'admin/selectCheckedCorrelation';//获得问卷题目的互斥
        var data = {
            problemNum: questionnaireId,
            answerNum: checkedList,
            questionId: id
